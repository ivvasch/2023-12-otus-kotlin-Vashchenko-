...
@Suppress("unused")
fun apiVqRequestSerialize(request: IRequest): String = apiV1Mapper.writeValueAsString(request)

@Suppress("UNCHECKED_CAST", "unused")
fun <T: IRequest> apiV1RequestDesrialize(json: String): T = apiV1Mapper.readValue(json, IRequest::class.java) as T
